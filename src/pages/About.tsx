          ...
          gridTemplateRows: 'auto'
            ...
            once: true
              ...
              <>
                  ...
                  {/* 第二张图片 */}
                  <div className="aspect-square overflow-hidden rounded-sm">
                    <img src="https://static-us-img.skywork.ai/prod/user/head_picture/2025924578608857088_photo-1618414736027-135f903d942f.jpg?image_process=quality,q_90/resize,w_1280/format,webp" alt={language === 'zh' ? '极简设计理念' : 'Minimalist Design'} className="w-full grayscale hover:grayscale-0 transition-all duration-500 h-[389.328125px] object-cover" />
                  </div>
